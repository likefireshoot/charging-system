  ...
  <div class="user-info-dialog" v-if="user_info_dialogFormVisible">
    <div class="user-info-dialog-content">
      ...
      <div class="user-info-content">
        ...
        <div class="user-info-input" style="margin-right: 1%">
          <span>性别</span>
          <el-select v-model="userInfoData.sexy">
        ...
        <div class="user-info-input" style="margin-right: 1%">
          <span>住址</span>
          <el-input v-model="userInfoData.region" />
        </div>
        <div class="user-info-input" style="margin-right: 1%">
          <span>手机号</span>
...
const adminNavList = reactive([
  ...
  { id: 1, name: "用户管理", icon: require("@//assets/menu/icon3.png"), icon2: require("@/assets/menu/icon4.png"), path: "/userManage" },
  { id: 2, name: "价格管理", icon: require("@/assets/menu/icon5.png"), icon2: require("@/assets/menu/icon6.png"), path: "/priceManage" },
  // { id: 3, name: "发票管理", icon: require("@/assets/menu/icon7.png"), icon2: require("@/assets/menu/icon8.png"), path: "/invoiceManage" },
  {
    ...
    arrowIcon2,
    children: [
      { id: 41, name: "日报表", icon: require("@/assets/menu/icon11.png"), icon2: require("@/assets/menu/icon12.png"), path: "/report/dailyReport" },
      { id: 42, name: "周报表", icon: require("@/assets/menu/icon13.png"), icon2: require("@/assets/menu/icon14.png"), path: "/report/weeklyReport" },
      { id: 43, name: "月报表", icon: require("@/assets/menu/icon15.png"), icon2: require("@/assets/menu/icon16.png"), path: "/report/monthlyReport" },
      { id: 44, name: "年报表", icon: require("@/assets/menu/icon17.png"), icon2: require("@/assets/menu/icon18.png"), path: "/report/yearlyReport" },
    ],
  },
  {
    id: 5,
...
function handleEditUserInfo() {
  ...
  service.post("/queryUsers", params).then((response) => {
    if (response.code === 200) {
      userInfoData.username = response.data.records[0].username;
      userInfoData.sexy = response.data.records[0].sexy;
      userInfoData.region = response.data.records[0].region;
      userInfoData.phone = response.data.records[0].phone;
...
function Confirm() {
  const validations = [
    {
      condition: userInfoData.username === "",
      message: "用户名不能为空",
    },
    {
      condition: userInfoData.sexy === "",
      message: "性别不能为空",
    },
    {
      condition: userInfoData.region === "",
      message: "住址不能为空",
    },
    // {
    ...
    {
      condition: userInfoData.phone === "" || !/^1[34578]\d{9}$/.test(userInfoData.phone),
      message: "手机号格式不对",
    },
  ];
