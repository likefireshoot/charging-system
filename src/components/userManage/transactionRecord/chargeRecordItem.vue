<!--此页面已弃用 功能转到userRecordDetail-userRecordTabs-BillTable-->
<!--此页面已弃用 功能转到userRecordDetail-userRecordTabs-BillTable-->
<!--此页面已弃用 功能转到userRecordDetail-userRecordTabs-BillTable-->
<template>
...
<!--        <div class="detail-entry" @click="goToBillDetail">点击查看详情</div>-->
      ...
      <div class="transaction-table">
        ...
        >
          ...
          <el-table-column property="chargeAmount" label="扣费金额" min-width="70" align="center" />
