    ...
    <div class="add-dialog-content">
      <div class="title">
        <div style="margin-left: 10px; display: flex; align-items: center">
          <img src="@/assets/yonghu/icon17.png" alt="" style="margin-right: 8px" />
          <span style="font-size: 20px">关阀控制</span>
        </div>
        ...
        <el-form :model="valveData" :rules="rules" class="add-content" style="padding: 0; width: 100%; height: 80px">
          ...
          <div class="add-input" style="margin-right: 2%">
            ...
            <el-radio-group v-model="valveData.valveShutMethod" style="height: 35px; width: 100%; margin-bottom: 18px">
              <el-radio value="自动关阀" class="recharge-green">自动关阀</el-radio>
              <el-radio value="手动关阀" class="recharge-green">手动关阀</el-radio>
            </el-radio-group>
          </div>
        </el-form>
      </div>
      <div class="btn">
        <div class="confirm-btn" @click="handleCommit">
          ...
          <span style="font-size: 20px; margin-left: 8%">确认</span>
        </div>
        <div class="cancel-btn" @click="handleValveClose">
          <el-icon style="margin-left: 15%; color: #45ba7e"><Close /></el-icon>
          <span style="font-size: 20px; margin-left: 8%; color: #5a5a5a">取消</span>
        </div>
      </div>
    </div>
  </div>
