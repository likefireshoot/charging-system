<template>
  <div class="recharge-record-dialog" v-if="changeBalanceRecord_dialogFormVisible">
    <div class="recharge-record-dialog-content">
      <div class="title">
        <div style="margin-left: 10px; display: flex; align-items: center">
          <img src="@/assets/yonghu/icon7.png" alt="" style="margin-right: 8px" />
          <span style="font-size: 20px">余额调整记录</span>
        </div>
        <div style="margin-right: 10px; cursor: pointer" @click="handleChangeBalanceRecordDialogClose">
        ...
        <div class="recharge-record-list">
          ...
          <div class="recharge-record-table">
            ...
            >
              ...
              <el-table-column property="beforeVal" label="调整前余额" min-width="130" align="center" />
              <el-table-column property="afterVal" label="调整后余额" min-width="130" align="center" />
...
export default {
  props: {
    changeBalanceRecord_dialogFormVisible: {
      type: Boolean,
      default: false,
    },
    data: {
  ...
  methods: {
    ...
    // 关闭弹窗
    handleChangeBalanceRecordDialogClose() {
      this.$emit("close");
    },
    // 多选框选中事件
