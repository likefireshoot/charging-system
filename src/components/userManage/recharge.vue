    ...
    <div class="recharge-dialog-content">
      ...
      <div class="recharge-content">
        <div class="recharge-input" style="margin-right: 1%">
          <span>用户名称</span>
          <el-input v-model="rechargeData.user_name" disabled />
        </div>
        <div class="recharge-input" style="margin-right: 1%">
          <span>表号</span>
        ...
        <div class="recharge-input" style="margin-right: 1%">
          <span>交易方式</span>
          <el-select v-model="rechargeData.payType">
...
export default {
  ...
  methods: {
    ...
    assignmentData() {
      this.rechargeData.user_name = this.data.user_name;
      this.rechargeData.balance = this.data.balance;
      this.rechargeData.water_meter_uid = this.data.water_meter_uid;
    ...
    handleConfirm() {
      ...
      let dataParams = { meterCode: formData.meterCode, water_meter_uid: formData.water_meter_uid, recharge_type: formData.payType, recharge_price: null };
      if (formData.quickmoney) {
        dataParams.recharge_price = formData.quickmoney;
      } else if (formData.money) {
        dataParams.recharge_price = formData.money;
      }
