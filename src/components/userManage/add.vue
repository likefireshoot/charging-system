        ...
        <el-form :model="addData" :rules="rules" class="edit-content" style="padding: 0; width: 100%; height: 320px">
          <div class="edit-input" style="margin-right: 1%">
            ...
            <el-form-item prop="user_name">
              <el-input v-model="addData.user_name" class="input-item" />
            </el-form-item>
          </div>
          <div class="edit-input" style="margin-right: 1%">
            <span>用户住址</span>
            <el-form-item prop="user_address">
              <el-input v-model="addData.user_address" class="input-item" />
            </el-form-item>
          </div>
          <div class="edit-input" style="margin-right: 1%">
            <span>所属区域</span>
            <el-form-item prop="user_for_town_id">
              <el-select v-model="addData.user_for_town_id" class="input-item">
          ...
          <div class="edit-input" style="margin-right: 1%; width: 24%">
            ...
            <el-form-item prop="phone">
              <el-input v-model="addData.phone" class="input-item" />
            </el-form-item>
          </div>
          <div class="edit-input" style="margin-right: 1%; width: 24%">
            <span>表号</span>
            <el-form-item prop="water_meter_uid">
              <el-input v-model="addData.water_meter_uid" class="input-item" />
            </el-form-item>
          </div>
          <div class="edit-input" style="margin-right: 1%; width: 24%">
            <span>IMEI号</span>
          ...
          <div class="edit-input" style="margin-right: 1%; width: 24%">
            <span>水表厂商</span>
            <el-form-item prop="changshang">
              <el-select v-model="addData.vendorId" class="input-item">
                <el-option v-for="item in changshang_list" :key="item.id" :label="item.label" :value="item.value"></el-option>
              </el-select>
            </el-form-item>
          </div>
          <div v-if="addData.vendorId === 1 || addData.vendorId === 2" class="edit-input" style="margin-right: 1%">
            <span>产品ID</span>
            <el-form-item>
          ...
          <div class="edit-input" style="margin-right: 1%; width: 24%">
            <span>水表类型</span>
            <el-form-item prop="water_meter_type_id">
              <el-select v-model="addData.water_meter_type_id" class="input-item">
                <el-option v-for="item in shuibiao_list" :key="item.id" :label="item.label" :value="item.id"></el-option>
              </el-select>
            </el-form-item>
          </div>
          <div class="edit-input" style="margin-right: 1%; width: 24%">
            <span>价格类型</span>
            <el-form-item prop="water_meter_price_type_id">
          ...
          <div class="edit-input" style="margin-right: 1%; width: 23.7%">
            <span>短信配置</span>
            <el-form-item prop="sms_config">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        user_address: [{ required: true, message: "请输入用户住址", trigger: "blur" }],
        user_for_town_id: [{ required: true, message: "请选择所属区域", trigger: "change" }],
        phone: [{ required: true, message: "请输入联系电话", trigger: "blur" }],
        water_meter_uid: [{ required: true, message: "请输入表号", trigger: "blur" }],
        imei: [{ required: true, message: "请输入IMEI号", trigger: "blur" }],
        changshang: [{ required: true, message: "请选择水表厂商", trigger: "blur" }],
        water_meter_type_id: [{ required: true, message: "请选择水表类型", trigger: "blur" }],
        water_meter_price_type_id: [{ required: true, message: "请选择价格类型", trigger: "blur" }],
        balance: [{ required: true, message: "请输入余额", trigger: "blur" }],
        sms_config_list: [{ required: true, message: "请选择短信配置", trigger: "blur" }],
      },
    };
  },
  mounted() {
  ...
  methods: {
    ...
    handleCommit() {
      let missingFields = [];
      let formData = {};
      if (this.addData.vendorId === 1 || this.addData.vendorId === 2) {
        formData = this.addData;
      } else {
        formData = {
          user_name: this.addData.user_name,
          user_address: this.addData.user_address,
          user_for_town_id: this.addData.user_for_town_id,
          phone: this.addData.phone,
          water_meter_uid: this.addData.water_meter_uid,
          imei: this.addData.imei,
          vendorId: this.addData.vendorId,
          water_meter_type_id: this.addData.water_meter_type_id,
          priceId: this.addData.priceId,
          balance: this.addData.balance,
      ...
      const fieldNameMap = {
        user_name: "用户名称",
        user_address: "用户住址",
        user_for_town_id: "所属区域",
        phone: "联系电话",
        water_meter_uid: "表号",
        imei: "IMEI号",
        vendorId: "水表厂商",
        water_meter_type_id: "水表类型",
        priceId: "价格类型",
        balance: "余额",
        smsConfigId: "短信配置",
        productId: "产品ID",
