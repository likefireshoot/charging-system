        ...
        <div class="recharge-record-list">
          ...
          <div class="recharge-record-table">
            ...
            >
              ...
              <el-table-column property="userId" label="用户号" width="120" align="center" />
              ...
              <el-table-column property="priceName" label="交易方式" width="240" align="center" />
              <el-table-column property="rechargeAmount" label="充值金额/元" width="240" align="center" />
              ...
              <el-table-column property="createTime" label="充值时间" width="240" align="center" />
            </el-table>
          </div>
        </div>
        <div class="page-box">
