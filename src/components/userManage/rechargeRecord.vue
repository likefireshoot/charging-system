        ...
        <div class="serach-box">
          ...
          <div class="search-input" style="width: 30%; margin-right: 10px">
            ...
            <div class="time-input">
              <el-select v-model="rechargeRecordeData.time.type" placeholder="请选择" style="width: 100px; margin-right: 10px">
              ...
              <div v-if="rechargeRecordeData.time.type === 'year'" style="margin-right: 0px; flex-grow: 1">
                <div style="display: flex; align-items: center">
                  <el-date-picker v-model="rechargeRecordeData.time.accurateTime" type="year" placeholder="选择年份" style="flex-grow: 1; width: 100%; height: 35px" value-format="YYYY" />
                </div>
              </div>
              <div v-if="rechargeRecordeData.time.type === 'month'" style="margin-right: 0px; flex-grow: 1">
                <div style="display: flex; align-items: center">
                  <el-date-picker v-model="rechargeRecordeData.time.accurateTime" type="month" placeholder="选择月份" style="flex-grow: 1; width: 100%; height: 35px" value-format="YYYY-MM" />
                </div>
              </div>
              <div v-if="!rechargeRecordeData.time.type || rechargeRecordeData.time.type === 'day'" style="margin-right: 0px; flex-grow: 1">
                <div style="display: flex; align-items: center">
                  <el-date-picker
                    v-model="rechargeRecordeData.time.accurateTime"
                    type="date"
                    placeholder="选择日期"
          ...
          <div class="search-input" style="width: 18%; margin-right: 10px">
            <span>表号</span>
            <el-input v-model="rechargeRecordeData.water_meter_uid" placeholder="请输入..." />
          </div>
          <div class="search-input" style="width: 21%; margin-right: 10px">
            <span>IMEI号</span>
            <el-input v-model="rechargeRecordeData.imei" placeholder="请输入..." />
          </div>
        ...
        <div class="recharge-record-list">
          ...
          <div class="recharge-record-table">
            <el-table
              ...
              :data="rechargeRecordTableData"
              row-key="index"
              style="width: auto; table-layout: fixed; overflow-x: auto; overflow-y: auto"
            ...
            >
              ...
              <el-table-column property="user_name" label="用户名称" width="240" align="center" />
              <el-table-column property="user_address" label="用户地址" width="240" align="center" />
              <el-table-column property="user_region" label="所属区域" width="240" align="center" />
              <el-table-column property="phone" label="联系电话" width="240" align="center" />
              <el-table-column property="water_meter_uid" label="表号" width="240" align="center" />
              ...
              <el-table-column property="bef_recharge_price" label="充值前余额/元" width="240" align="center" />
              <el-table-column property="recharge_price" label="充值金额/元" width="240" align="center" />
              <el-table-column property="aft_recharge_price" label="充值后余额/元" width="240" align="center" />
              <el-table-column property="report_time" label="充值日期" width="240" align="center" />
            </el-table>
          </div>
        </div>
        <div class="page-box">
...
export default {
  ...
  methods: {
    ...
    getRechargeRecordData() {
      service
        .get(`/userManage/userCharge/showRechargeMeterRecords/${this.currentPage}`)
        .then((response) => {
          if (response.code === 200) {
            this.rechargeRecordTableData = response.data.userInfoData;
    ...
    reflush() {
      service
        .get("/userManage/userCharge/showRechargeMeterRecords/1")
        .then((response) => {
          if (response.code === 200) {
            this.rechargeRecordTableData = response.data.userInfoData;
            this.rechargeRecordTableData.forEach((item) => {
    ...
    clear() {
      ...
      this.rechargeRecordeData.time.type = null;
      this.rechargeRecordeData.time.record_time = "";
      this.rechargeRecordeData.username = "";
      this.rechargeRecordeData.water_meter_uid = "";
    ...
    exportExcel() {
      // 调用后端接口
      axios({
        url: "userManage/userCharge/exportMeterRechargeReport", // 后端接口地址
        method: "GET",
