      ...
      <div class="chaobiao-record-content">
        ...
        <div class="chaobiao-list">
          <div class="command-buttons">
            <div class="export-out-btn" style="margin-right: 10px; width: 110px" @click="download" v-if="staffPermissionIds.includes(16)">
            ...
            <div class="export-in-btn" style="margin-right: 10px" @click="triggerFileInput" v-if="staffPermissionIds.includes(16)">
              <img src="@/assets/yonghu/icon1.png" alt="" style="margin-left: 7px" />
          ...
          <div class="chaobiao-table">
            ...
            >
              ...
              <el-table-column property="userPhone" label="手机号" width="240" align="center" />
              ...
              <el-table-column property="createTime" label="抄表时间" width="240" align="center" />
              <el-table-column property="readingCount" label="水表读数/吨" width="240" align="center" />
              <el-table-column property="valveStatus" label="阀门状态" width="240" align="center" />
              <!-- <el-table-column property="balance" label="余额/元" width="120" align="center" /> -->
              <el-table-column property="battery" label="电量" width="240" align="center" />
              <el-table-column property="signalValue" label="信号值" width="240" align="center" />
            </el-table>
          </div>
        </div>
        <div class="page-box">
