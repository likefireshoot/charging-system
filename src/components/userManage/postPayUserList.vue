...
export default {
  ...
  props: {
    post_pay_list_dialogFormVisible: {
      type: Boolean,
      default: false,
    },
    data: {
  ...
  methods: {
    ...
    filterNonEmptyParams(params) {
      ...
      filteredParams.enableArrearsValve = 1;
