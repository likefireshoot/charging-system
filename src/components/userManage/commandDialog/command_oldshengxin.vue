<template>
  ...
  <div class="command-dialog" v-if="command_dialogFormVisible">
    <div class="command-dialog-content" v-if="commandType == '旧圣鑫'">
      <div class="title">
      ...
      <div class="command-content">
        ...
        <div class="command-params">
          ...
          <div class="btns">
            <div class="confirm-btn" @click="commit_oldshengxin">
    ...
    commit_oldshengxin() {
      if (this.node.label === "阀门控制") {
        ...
        this.$refs.valveForm.validate((valid) => {
          ...
          service
            .get(`/command/oldShengXin/oldShengXinValveCommand?meterCode=${meterCode}&status=${status}`)
            .then((res) => {
              if (res.code === 200) {
        ...
        this.$refs.trafficForm.validate((valid) => {
          ...
          service
            .get(`/command/oldShengXin/sendOldShengXinCumulativeTrafficCommand?meterCode=${meterCode}&cumulativeTraffic=${cumulativeTraffic}`)
            .then((res) => {
              if (res.code === 200) {
