      ...
      <div class="baobiao-chart">
        <div class="week-report">
          <div class="week-report-title">
            <span style="font-size: 16px; margin-top: 10px; margin-bottom: 5px">周报表统计（{{ params.startTime }}至{{ params.endTime }}）</span>
        ...
        <div class="week-huanbi">
          <div class="week-huanbi-title">
            <span style="font-size: 16px; margin-top: 10px; margin-bottom: 5px">周报表统计环比（{{ params.startTime }}至{{ params.endTime }}）</span>
            <div class="flex-container">
              <div style="width: 4px; height: 4px; background-color: #46b87d; margin-right: 5px"></div>
              <div style="width: 4px; height: 4px; background-color: #90d5b2; margin-right: 5px"></div>
              <div style="width: 4px; height: 4px; background-color: #c7ead7; margin-right: 5px"></div>
        ...
        <div class="week-tongbi">
          <div class="week-tongbi-title">
            <span style="font-size: 16px; margin-top: 10px; margin-bottom: 5px">周报表统计同比（{{ params.startTime }}至{{ params.endTime }}）</span>
            <div class="flex-container">
              <div style="width: 4px; height: 4px; background-color: #46b87d; margin-right: 5px"></div>
              <div style="width: 4px; height: 4px; background-color: #90d5b2; margin-right: 5px"></div>
              <div style="width: 4px; height: 4px; background-color: #c7ead7; margin-right: 5px"></div>
...
export default {
    ...
    "params.startTime": function (newStartTime) {
      if (newStartTime) {
        ...
        if (endDateObj > currentDate) {
          ...
          newStartDateObj.setDate(currentDate.getDate() - 7);
  ...
  methods: {
    ...
    getTradeData() {
      ...
      service
        .get(`/weekReport?startTime=${this.params.startTime}&endTime=${this.params.endTime}&region=${this.params.region}`)
        .then((response) => {
          if (response.code === 200) {
