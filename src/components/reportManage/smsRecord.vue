    ...
    <div class="tongzhi-info">
      ...
      <div class="tongzhi-table">
        ...
        >
          ...
          <el-table-column property="userAddr" label="用户住址" width="240" align="center" />
          ...
          <el-table-column property="createTime" label="短信发送时间" width="240" align="center" />
          <el-table-column property="balance" label="当前余额/元" width="240" align="center" />
          <el-table-column property="monthlyWaterCosts" label="本月用水量/吨" width="240" align="center" />
          <el-table-column property="monthlyMoneyCosts" label="本月消费金额/元" width="240" align="center" />
          <el-table-column property="arrears" label="欠费金额/元" width="240" align="center" />
          <el-table-column property="minimumBalanceThreshold" label="余额不足触发值/元" width="240" align="center" />
