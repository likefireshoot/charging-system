    ...
    <div class="search-box">
      <div class="search-content">
        <div class="search-input" style="margin-left: 10px; width: 25%">
          <span>所属区域</span>
          <el-select v-model="params.userRegion" placeholder="请选择...">
        ...
        <!-- <div class="search-input" style="margin-left: 10px">
          <span>表号</span>
          <el-input v-model="params.waterMeterUid" type="number" placeholder="请输入..." />
        </div> -->
        <div class="search-input" style="margin-left: 10px">
          <span>IMEI号</span>
    ...
    <div class="tongzhi-info">
      ...
      <div class="tongzhi-table">
        ...
        >
          ...
          <el-table-column property="index" label="序号" width="120" align="center" fixed="left" />
          <el-table-column property="userName" label="用户名称" width="240" align="center" />
          <el-table-column property="uuid" label="用户号" width="240" align="center" />
          <el-table-column property="userRegion" label="所属区域" width="240" align="center" />
          <el-table-column property="userAddress" label="用户住址" width="240" align="center" />
          <el-table-column property="phone" label="联系电话" width="240" align="center" />
          <!-- <el-table-column property="waterMeterUid" label="表号" width="240" align="center" /> -->
          <el-table-column property="imei" label="IMEI号" width="240" align="center" />
          <el-table-column property="monthlyWaterConsume" label="用水量/吨" width="240" align="center" />
          <el-table-column property="monthlyMoneyConsume" label="本月消费金额/元" width="240" align="center" />
          <el-table-column property="balance" label="余额/元" width="240" align="center" />
          <el-table-column property="arrears" label="欠费金额/元" width="240" align="center" />
          <el-table-column property="smsSendBound" label="余额不足触发值/元" width="240" align="center" />
          <el-table-column property="reportTime" label="短信发送时间" width="240" align="center" />
...
export default {
  ...
  methods: {
    ...
    getSmsRecordData() {
      ...
      service
        .post("/querySmsRecord", filteredParams)
        .then((response) => {
          if (response.code === 200) {
    ...
    clear() {
      this.params.userRegion = "";
      this.params.userAccount = "";
      this.params.userName = "";
      this.params.waterMeterUid = null;
