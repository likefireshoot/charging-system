    ...
    <div class="container1">
      ...
      <div class="week-report">
        <div class="week-report-title">
          <span style="font-size: 16px; margin-top: 10px; margin-bottom: 5px">近7天缴费总额</span>
          <div class="flex-container">
            <div style="width: 4px; height: 4px; background-color: #46b87d; margin-right: 5px"></div>
            <div style="width: 4px; height: 4px; background-color: #90d5b2; margin-right: 5px"></div>
            <div style="width: 4px; height: 4px; background-color: #c7ead7; margin-right: 5px"></div>
    ...
    <div class="container2">
      <div class="shebei-warning" style="width: 320px">
        ...
        <div class="shebei-warning-list">
          <div class="shebei-warning-item">
            ...
            <div class="shebei-warning-item-text" @click="goToDetail('欠费用户')">
          ...
          <div class="shebei-warning-item">
            ...
            <div class="shebei-warning-item-text" @click="goToDetail('水表0用量用户')">
          ...
          <div class="shebei-warning-item">
            ...
            <div class="shebei-warning-item-text" @click="goToDetail('大用量异常用户')">
          ...
          <div class="shebei-warning-item">
            ...
            <div class="shebei-warning-item-text" @click="goToDetail('数据持续未上报')">
          ...
          <div class="shebei-warning-item">
            ...
            <div class="shebei-warning-item-text" @click="goToDetail('设备异常')">
      ...
      <div class="month-year-report">
        <div class="month-report">
          <span style="font-size: 16px; margin-top: 10px; margin-bottom: 5px">本月缴费情况</span>
          <div class="flex-container">
            <div style="width: 4px; height: 4px; background-color: #46b87d; margin-right: 5px"></div>
            <div style="width: 4px; height: 4px; background-color: #90d5b2; margin-right: 5px"></div>
            <div style="width: 4px; height: 4px; background-color: #c7ead7; margin-right: 5px"></div>
        ...
        <div class="year-report">
          <span style="font-size: 16px; margin-top: 10px; margin-bottom: 5px">本年度结算总额情况</span>
          <div class="flex-container">
            <div style="width: 4px; height: 4px; background-color: #46b87d; margin-right: 5px"></div>
            <div style="width: 4px; height: 4px; background-color: #90d5b2; margin-right: 5px"></div>
            <div style="width: 4px; height: 4px; background-color: #c7ead7; margin-right: 5px"></div>
...
export default {
  ...
  methods: {
    ...
    getWeekData() {
      ...
      service
        .get(`/weekReport?startTime=${formattedStartTime}&endTime=${this.params.record_time}&region=`)
        .then((response) => {
    ...
    getMonthData() {
      ...
      service
        .get(`/monthReport?month=${month}&region=`)
        .then((response) => {
          if (response.code === 200) {
    ...
    getYearData() {
      ...
      service
        .get(`/yearReport?year=${year}&region=`)
        .then((response) => {
          if (response.code === 200) {
            const totalMoneys = response.data.currentSingularReport.map((item) => {
              return item.totalMoney;
    ...
    //获取表统计数据
    async getTotal() {
      service.get("/GetExceptionDeviceNum").then((res) => {
        if (res.code === 200) {
...
.shebei-warning-list {
  display: flex;
  flex-direction: column;
  justify-content: space-between; /* 使子元素在垂直方向上均匀分布 */
  width: 100%;
  height: 90%;
  margin-left: 5%;
}
