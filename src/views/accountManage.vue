      ...
      <div class="user-list">
        ...
        <div class="user-table">
          ...
          >
            ...
            <el-table-column property="userName" label="用户名称" width="230" align="center"> </el-table-column>
            <el-table-column property="userAddr" label="用户地址" width="320" align="center" />
            <el-table-column property="companyName" label="所属水厂" width="300" align="center" />
            <el-table-column property="regionName" label="所属区域" width="300" align="center" />
            <el-table-column property="userPhone" label="联系电话" width="300" align="center" />
            <el-table-column property="meterCode" label="表号" width="300" align="center" />
            <el-table-column property="meterType" label="水表类型" width="300" align="center" />
            <el-table-column property="priceName" label="价格类型" width="300" align="center" />
            <el-table-column property="smsConfigName" label="短信配置" width="300" align="center"></el-table-column>
            <el-table-column property="approver1" label="开户审批人1" width="240" align="center" />
            <el-table-column property="approver2" label="开户审批人2" width="240" align="center" />
            <el-table-column property="approver3" label="开户审批人3" width="240" align="center" />
