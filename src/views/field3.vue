...
async function getTrack() {
  ...
  frametList.push(mapMarketPolylines.UserTrack[mapMarketPolylines.UserTrack.length - 1]);

  mapMarketPolylines.marketArray = frametList;
...
function play() {
  ...
  if (videoData.playType == 1) {
    if (videoData.playLength < length) {
